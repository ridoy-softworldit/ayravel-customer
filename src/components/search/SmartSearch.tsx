  ...
  return (
    <div className={`relative w-full ${className}`}>
      ...
      <div className="relative flex items-center">
        ...
        <button
          type="button"
          className="absolute right-0 top-1/2 -translate-y-1/2 bg-[#d4a017] text-white rounded-r-3xl p-3 hover:bg-[#6b4c3e] transition-colors flex items-center justify-center"
          aria-label="Search"
