...
export default function MainMenu() {
  ...
  return (
    <div className="relative hidden lg:block left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen bg-[#d4a017]">
      <div className="container mx-auto w-full px-3 md:px-6 lg:px-36">
        <div className="flex items-center justify-between py-2 h-10">
          {/* Left menu */}
          <nav className="flex items-center gap-5 text-sm font-medium text-white pl-6">
          ...
          <div className="flex items-center gap-4 text-white">
            {!isLoggedIn ? (
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  <div className="relative">
                    <Image
                      ...
                      width={28}
                      height={28}
                      className="rounded-full object-cover border-2 border-secondary/30 group-hover:border-secondary/60 transition-colors"
                      sizes="28px"
                      priority
                      onError={(e) => {
                ...
                <button
                  ...
                  aria-label="Logout"
                  className="inline-flex items-center gap-1 rounded-md border border-red-300 bg-white text-red-600 px-2 py-1 text-sm hover:bg-red-50 hover:border-red-400 disabled:opacity-60 transition-colors"
            ...
            <Link 
              ...
              className="relative inline-flex p-2 rounded-md hover:bg-secondary/10 transition-colors" 
              aria-label="Cart"
            >
              <ShoppingCart size={20} />
              {cartCount > 0 && (
                <span className="absolute -top-1 -right-1 h-5 min-w-5 px-1 rounded-full text-xs bg-highlight text-accent flex items-center justify-center font-medium">
