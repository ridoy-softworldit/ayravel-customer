    ...
    <section className="w-full">
      <div className="container mx-auto px-3 sm:px-4 lg:px-6">
        ...
        <div className="mb-3 flex items-center justify-between">
          ...
          <Link href="/reviews" className="text-sm text-black hover:underline">
            View all
          </Link>
        </div>
              ...
              >
                ...
                >
                  ...
                  <div className="mt-auto">
                    <span className="inline-flex w-full items-center justify-center h-9 rounded-md text-black text-sm font-bold hover:opacity-90">
                      View details
                    </span>
                  </div>
                </Link>
