          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3 sm:gap-4">
            {items.map((p) => {
              ...
              return (
                ...
                >
                  <span className="absolute top-2 right-2 z-10 px-2 py-0.5 rounded-md text-[11px] font-semibold text-white bg-[#d4a017]">
                    {pct}%
                  </span>
                  ...
                  <div className="mt-3 text-center text-[13px] sm:text-sm font-medium text-gray-900 min-h-[40px]">
                    {p.title}
                  </div>
                  ...
                  <div className="mt-auto">
                    <button className="inline-flex w-full items-center justify-center h-9 rounded-md text-black text-sm font-bold hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#795548]">
                      Buy now
                    </button>
                  </div>
                </Link>
