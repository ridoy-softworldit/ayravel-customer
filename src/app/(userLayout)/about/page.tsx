...
export const metadata = {
  title: "About — AYraveL",
  description:
    "Learn about AYraveL — our story, values, team, and what we’re building for shoppers and sellers.",
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              ...
              <p className="mt-3 text-gray-600 max-w-2xl">
                AYraveL is a modern marketplace experience where brands, creators,
            ...
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden border border-gray-200 bg-white">
              <Image
                ...
                alt="AYraveL marketplace preview"
                fill
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          <div className="order-2 lg:order-1">
            ...
            <p className="mt-3 text-gray-600">
              AYraveL started with a simple question:{" "}
            ...
            <p className="mt-3 text-gray-600">
              Today, AYraveL offers curated collections, category-first
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <ul className="mt-4 space-y-4">
          <li className="flex gap-3">
            <div className="w-2 h-2 mt-2 rounded-full bg-[#d4a017]" />
          ...
          <CardContent className="p-6 sm:p-8 flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link href="/auth/login">
                <Button variant="outline">Join AYraveL</Button>
              </Link>
            </div>
          </CardContent>
        </Card>
