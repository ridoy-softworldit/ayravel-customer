            ...
            {categories.map((c) => (
              <button
                ...
                className={[
                  ...
                  activeCat === c
                    ? "bg-[#d4a017] text-white border-[#795548]"
              ...
              >
                {p.rating >= 4.5 && (
                  <div className="absolute left-2 top-2 z-10">
                    <span className="inline-block rounded-full bg-[#d4a017] text-white text-[10px] px-2 py-0.5 font-semibold">
                      TOP
                    </span>
                  </div>
                )}
                ...
                <CardContent className="p-3">
                  ...
                  <div className="mt-3 flex gap-2">
                    ...
                    >
                      <Button className="w-full bg-[#d4a017] hover:bg-[#d4a017]/90 text-white">View</Button>
                    </Link>
                    <Button
                      variant="outline"
                      className={clsx("w-10 px-0", {
                        'bg-green-600 hover:bg-green-600 text-white': isAddedToCart(p.id),
                        'hover:bg-[#d4a017] hover:text-white': !isAddedToCart(p.id)
                      })}
