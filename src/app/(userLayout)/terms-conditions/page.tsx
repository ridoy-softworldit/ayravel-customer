...
const termsContent = {
    acceptance: { title: "Acceptance of Terms", content: ["By accessing and using AYraveL website (www.ayravel.com), you accept and agree to be bound by these terms and conditions", "If you do not agree to these terms, please discontinue use of our website and services immediately", "These terms constitute the entire legal agreement between you and AYraveL regarding your use of our platform", "Any modifications to these terms must be agreed upon in writing by AYraveL management and will be posted on this page", "Your continued use of the website after changes indicates acceptance of the modified terms", "Users must be at least 18 years old or have parental consent to use our services"] },
  ...
  "
        >
          ...
          <p className="text-sm sm:text-base text-secondary-600">
            Contact us at ayravelmanager@gmail.com for any terms-related questions.
          </p>
