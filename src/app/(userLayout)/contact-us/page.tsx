    ...
    <div className="p-4 md:p-8 lg:p-16 mx-auto max-w-7xl bg-accent min-h-screen">
                ...
                <div className="relative flex gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <p className="whitespace-nowrap">Mirpur, Dhaka, Bangladesh</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="mt-16">
        <div className="w-full h-[400px] rounded-xl overflow-hidden">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d58418.766877314!2d90.3293!3d23.7956!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c0e96fce29dd%3A0x6ccd9e51aba9e64d!2sMirpur%2C%20Dhaka%2C%20Bangladesh!5e0!3m2!1sen!2s!4v1703123456789!5m2!1sen!2s"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen
            ...
            title="Mirpur, Dhaka, Bangladesh Map"
          />
        </div>
